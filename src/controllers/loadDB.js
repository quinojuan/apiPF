...
const loadDb = async () => {
  try {
    ...
    let usersAxios = await axios.get("https://api-movilgates.onrender.com/firebase/allusers");
	...
	await Users.destroy({
		where: { email: "pavifet170@cebaike.com" },
	});
	
    await Users.create({
		email: "pavifet170@cebaike.com",
		name: "Administrador",
		password: null,
		admin: true,
		superadmin: true,
