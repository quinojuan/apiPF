...
const { Brand, Phones, Users, Purchases, Feedbacks, Qas, Quantities } =
  sequelize.models;
/*
...
*/
Feedbacks.belongsToMany(Phones, {
  through: "PhoneFeedbacks",
  foreignKey: "FeedbacksId",
});
Phones.belongsToMany(Feedbacks, {
  through: "PhoneFeedbacks",
  foreignKey: "PhoneId",
});
Feedbacks.belongsToMany(Users, {
  through: "UsersFeedbacks",
  foreignKey: "FeedbacksId",
});
Users.belongsToMany(Feedbacks, {
  through: "UsersFeedbacks",
  foreignKey: "UsersId",
});
...
Quantities.belongsToMany(Phones, {
  through: "PhoneQuantities",
  foreignKey: "QuantitiesId",
});
Phones.belongsToMany(Quantities, {
  through: "PhoneQuantities",
  foreignKey: "PhoneId",
});
Quantities.belongsToMany(Purchases, {
  through: "PurchasesQuantities",
  foreignKey: "QuantitiesId",
});
Purchases.belongsToMany(Quantities, {
  through: "PurchasesQuantities",
  foreignKey: "PurchasesId",
});
